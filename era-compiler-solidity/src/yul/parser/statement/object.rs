...
impl<D> era_compiler_llvm_context::EraVMWriteLLVM<D> for Object<EraDialect>
where
...
impl<D> era_compiler_llvm_context::EVMWriteLLVM<D> for Object<EraDialect>
where
    D: era_compiler_llvm_context::Dependency,
{
    fn declare(
    ...
    fn into_llvm(
        ...
        let mut entry = era_compiler_llvm_context::EVMEntryFunction::new(self.code);
        entry.declare(context)?;
        entry.into_llvm(context)?;
        Ok(())
    }
