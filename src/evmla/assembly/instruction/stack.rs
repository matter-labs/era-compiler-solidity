    ...
    D: compiler_llvm_context::EraVMDependency + Clone,
{
    ...
    let value = context.build_load(
        compiler_llvm_context::EraVMPointer::new_stack_field(
            context,
    ...
    D: compiler_llvm_context::EraVMDependency + Clone,
{
    ...
    let top_pointer = compiler_llvm_context::EraVMPointer::new_stack_field(
        context,
    ...
    let swap_pointer = compiler_llvm_context::EraVMPointer::new_stack_field(
        context,
...
///
pub fn pop<D>(_context: &mut compiler_llvm_context::EraVMContext<D>) -> anyhow::Result<()>
where
    D: compiler_llvm_context::EraVMDependency + Clone,
{
    Ok(())
