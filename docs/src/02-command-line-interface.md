...
```javascript
{
    ...
    "ipfs": h'1220ba14ea4e52366f139a845913d41e98933393bd1c1126331611687003d4aa92de',
    ...
    // `solc:<version>;llvm:<version>` is included for Solidity and Yul input, but not included for LLVM IR and EraVM assembly input.
